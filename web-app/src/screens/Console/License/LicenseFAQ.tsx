  ...
  return (
    <Fragment>
      ...
      <p>
        ...
        with Hanzo S3 source code or at{" "}
        {makeLink(
          "https://www.gnu.org/licenses/agpl-3.0.en.html",
          "https://hanzo.space/compliance",
        )}
        .
      </p>
      <h2>What does it mean for me to comply with the GNU AGPL v3?</h2>
      <p>
        When you host or distribute Hanzo S3 over a network, the AGPL v3 applies to
        you. Any distribution or copying of Hanzo S3 software modified or not has
      ...
      <h2>Making combined or derivative works of Hanzo S3</h2>
      <p>
        Creating combined or derivative works of Hanzo S3 requires all such works
        to be released under the same license.
      </p>
      <p>
        If Hanzo S3 source code is included in the same executable file, they are
      ...
      <p>
        Merely aggregating Hanzo S3 software into your distribution does not
      ...
      <p>
        ...
        for legal advice. Purchasing a commercial license from Hanzo S3 removes the
        GNU AGPL v3 obligations from Hanzo S3 software.
      </p>
    </Fragment>
  );
};
